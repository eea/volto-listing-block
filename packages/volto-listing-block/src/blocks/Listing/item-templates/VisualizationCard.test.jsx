...
import { CardImage } from '@eeacms/volto-listing-block/components/UniversalCard';

const mockStore = configureStore([]);

// Mock the UniversalCard components
vi.mock('@eeacms/volto-listing-block/components/UniversalCard', () => ({
  CardDescription: vi.fn(() => (
    <div data-testid="card-description">Description</div>
  )),
  CardExtra: vi.fn(() => <div data-testid="card-extra">Extra</div>),
  CardImage: vi.fn(() => <div data-testid="card-image">Image</div>),
  CardMeta: vi.fn(() => <div data-testid="card-meta">Meta</div>),
  CardTitle: vi.fn(() => <div data-testid="card-title">Title</div>),
}));

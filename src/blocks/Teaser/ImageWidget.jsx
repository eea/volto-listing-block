//this is indented to disappear after the Volto ImageWidget is available
  ...
  useEffect(() => {
    if (loading && requestLoaded && uploading) {
      ...
      onChange(id, {
        ...
        '@id': content['@id'],
        title: content.title,
        image_scales: content?.image?.image_scales || [],
      });
    }
  }, [id, urlUploaded, requestLoaded, content, loading, uploading, onChange]);
